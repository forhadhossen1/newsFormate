...
function App() {
  ...
  return (
    <>
      <div>
        <h2 className="text-center font-bold text-3xl border-b-4 border-b-gray-500 w-1/3 mx-auto py-5">News Formate</h2>

        <div className="py-12 px-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus delectus quam hic ea eos ut odit sapiente? Dolorem, sapiente blanditiis! In enim debitis explicabo ipsum autem doloribus labore minus excepturi corrupti nobis, facilis quo saepe laboriosam qui ex? Enim harum nulla nostrum repellendus numquam quam debitis quos ut, officia quas iste nemo cumque exercitationem quae, accusantium, ipsum officiis voluptatibus error!
        </div>

        {/* <NewsFormate></NewsFormate> */}

<div>
  <h2 className="text-5xl font-bold text-center my-5 py-5 border-b-4 border-b-gray-500  mx-auto w-1/2">this is image gllery</h2>
</div>
        ...
        <h2 className="text-center font-bold text-3xl border-b-4 border-b-gray-500 w-1/3 mx-auto py-5">NavBar</h2>
